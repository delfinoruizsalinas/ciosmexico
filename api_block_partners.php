<section class="section-lg bg-gray-200 text-center">
    <div class="container">
        ...
        <!-- Owl Carousel-->
        <div class="owl-carousel owl-dots-secondary dots-offset-lg" data-items="1" data-sm-items="2" data-lg-items="4" data-autoplay="true" data-autoplaySpeed="true" data-dots="false" data-nav="false" data-stage-padding="0" data-loop="false" data-margin="30" data-mouse-drag="false">
        <?php      
