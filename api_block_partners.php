<section class="section-lg bg-gray-200 text-center">
    <div class="container">
        ...
        <!-- Owl Carousel-->
        <div class="owl-carousel owl-dots-secondary dots-offset-lg" data-items="4" data-autoplay="true" data-autoplaySpeed="true" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="true" data-margin="30" data-mouseDrag="true" data-touchDrag="true">
        <?php      
