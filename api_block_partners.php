<section class="section-lg text-center">
    <div class="container">
        ...
        <?php      
            ...
            curl_setopt($curl, CURLOPT_URL, 'https://ciosmexicanos.com:1337/api/partners?populate=imagen');
            ...
            foreach ($obj->data as $key => $value) {
                ...
                foreach($value->attributes->imagen as $item){
                        ...
                        if(empty($item->attributes->formats->thumbnail)){
                            $url = 'https://ciosmexicanos.com:1337'.$item->attributes->url;
                        }else{
                            $url = 'https://ciosmexicanos.com:1337'.$item->attributes->formats->thumbnail->url;                               
                        }
                }       
