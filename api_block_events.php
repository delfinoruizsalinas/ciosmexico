                    ...
                    foreach ($obj->data as $key => $value) {
                        if($key<$itm){
                          ...
                          echo '<div class="wow slideInUp">
                                  ...
                                  <div class="post-classic-figure"><a href="cios-presenciales-detalle.php.php?id='.$value->id.'&evento=presencial"><img src="'.$url.'" style="width: 370px; height: 255px;"/></a></div>
                                  <div class="post-classic-caption">
                                      <h4 class="post-classic-title"><a href="cios-presenciales-detalle.php.php?id='.$value->id.'&evento=presencial">'.$value->attributes->titulo.'</a></h4>
