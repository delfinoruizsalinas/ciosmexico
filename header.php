...
<div class="rd-navbar-wrap"> 
    <nav id="menudiv" class="rd-navbar rd-navbar-aside" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-static" data-xl-layout="rd-navbar-static" data-xl-device-layout="rd-navbar-static" data-lg-stick-up-offset="46px" data-xl-stick-up-offset="46px" data-xxl-stick-up-offset="46px" data-lg-stick-up="true" data-xl-stick-up="true" data-xxl-stick-up="true">
    <div class="rd-navbar-main-outer">
        <div class="rd-navbar-main">
        <!-- RD Navbar Panel-->
        <div class="rd-navbar-panel">
            <!-- RD Navbar Toggle-->
            <button class="rd-navbar-toggle menu-hamburg" data-rd-navbar-toggle=".rd-navbar-nav-wrap"><span></span></button>
            <!-- RD Navbar Brand-->
            <div class="rd-navbar-brand"><a class="brand" href="index.php">
                <img id="fixlogo" class="brand-logo-light" src="images/cios/logo_footer.png" alt="" width="150" height="38"/>
            </a>
            </div>
            ...
            <div class="rd-navbar-aside-outer rd-navbar-collapse">
                ...
                <ul class="list-inline header-soc-list">
                    ...
                    <li class="text-menu"><a class="icon fa-apple" href="https://podcasts.apple.com/mx/podcast/tecnologiando-con-cios-latam/id1646163844" target="_blank"></a></li>                                            
